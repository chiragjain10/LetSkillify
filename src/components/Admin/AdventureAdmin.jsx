...
export default function AdventureAdmin() {
  ...
  const fetchImages = async () => {
    setLoading(true);
    const snap = await getDocs(collection(db, "adventures"));
  ...
  return (
    <div className="container-fluid">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h3 className="mb-0">Adventures Gallery</h3>
      </div>
            ...
            {uploadedImages.map((img) => (
              <div key={img.id} className="col-md-3 col-sm-4 col-6">
                <div className="card border">
                  <img src={img.image} alt="Adventure" className="card-img-top" style={{ height: "150px", objectFit: "cover" }} />
