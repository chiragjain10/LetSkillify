	...
	<div className="container">
		<div className="row mb-4">
			<div className="col-12">
				<h2 className="fs-1 fw-bold">
					<span className="position-relative z-index-9">Our</span>
					<span className="position-relative z-index-1">Products
		...
		<div className="row g-4">
			<div className="col-md-6 col-xl-4">
				<div className="card shadow-hover overflow-hidden bg-transparent">
					<div className="position-relative">
						<img className="card-img-top" src="assets/images/courses/4by3/16.jpg" alt="Card image"/>
						...
						<div className="card-img-overlay d-flex align-items-start flex-column">
							<div className="w-100 mt-auto d-inline-flex">
								<div className="d-flex align-items-center bg-white p-2 rounded-2">
									...
									<div>
										<h6 className="mb-0"><a href="#" className="text-dark">Larry Lawson</a></h6>
					...
					<div className="card-body">
						<div className="d-flex justify-content-between mb-3">
							<div className="hstack gap-2">
								<a href="#" className="badge bg-orange bg-opacity-10 text-orange">All level</a>
								<a href="#" className="badge text-bg-dark">6 month</a>
							</div>
						...
						<div className="d-flex justify-content-between align-items-center mb-2">
							...
							<span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2"></i>6h 56m</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="col-md-6 col-xl-4">
				<div className="card shadow-hover overflow-hidden bg-transparent">
					<div className="position-relative">
						<img className="card-img-top" src="assets/images/courses/4by3/14.jpg" alt="Card image"/>
						<div className="bg-overlay bg-dark opacity-4"></div>
						<div className="card-img-overlay d-flex align-items-start flex-column">
							<div className="w-100 mt-auto d-inline-flex">
								<div className="d-flex align-items-center bg-white p-2 rounded-2">
									<div className="avatar avatar-sm me-2">
										<img className="avatar-img rounded-1" src="assets/images/avatar/08.jpg" alt="avatar"/>
									</div>
									<div>
										<h6 className="mb-0"><a href="#" className="text-dark">Billy Vasquez</a></h6>
					...
					<div className="card-body">
 						<div className="d-flex justify-content-between mb-3">
							<div className="hstack gap-2">
								<a href="#" className="badge bg-info bg-opacity-10 text-info">Beginner</a>
								<a href="#" className="badge text-bg-dark">8 month</a>
							</div>
							<a href="#" className="text-danger"><i className="fas fa-bookmark fa-fw"></i></a>
						</div>
						...
						<div className="d-flex justify-content-between align-items-center mb-2">
							...
							<span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2"></i>12h 56m</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="col-md-6 col-xl-4">
				<div className="card shadow-hover overflow-hidden bg-transparent">
					<div className="position-relative">
						<img className="card-img-top" src="assets/images/courses/4by3/21.jpg" alt="Card image"/>
						<div className="bg-overlay bg-dark opacity-4"></div>
						<div className="card-img-overlay d-flex align-items-start flex-column">
							<div className="w-100 mt-auto d-inline-flex">
								<div className="d-flex align-items-center bg-white p-2 rounded-2">
									<div className="avatar avatar-sm me-2">
										<img className="avatar-img rounded-1" src="assets/images/avatar/05.jpg" alt="avatar"/>
									</div>
									<div>
										<h6 className="mb-0"><a href="#" className="text-dark">Lori Stevens</a></h6>
					...
					<div className="card-body">
						<div className="d-flex justify-content-between mb-3">
							<div className="hstack gap-2">
								<a href="#" className="badge bg-info bg-opacity-10 text-info">Beginner</a>
								<a href="#" className="badge text-bg-dark">12 month</a>
							</div>
							<a href="#" className="h6 fw-light mb-0"><i className="far fa-bookmark fa-fw"></i></a>
						</div>
						...
						<div className="d-flex justify-content-between align-items-center mb-2">
							...
							<span className="h6 fw-light mb-0 me-3"><i className="far fa-clock text-danger me-2"></i>5h 40m</span>
						</div>
					</div>
				</div>
			</div>
